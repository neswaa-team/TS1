          ...
          <ModalBody>
            <Row className="row g-4">
              ...
              <Col sm={4}>
                ...
                <DateFormInput options={{ enableTime: false }} className="form-control" placeholder="Select date" />
              </Col>
              <div className="col-sm-4">
                <label className="form-label">Time</label>
                <DateFormInput options={{ enableTime: true, noCalendar: true }} className="form-control" placeholder="Select time" />
              </div>
