      ...
      <Card className="card-chat rounded-start-lg-0 border-start-lg-0">
        <CardBody className="h-100">
          <div className="h-100">
              ...
              <div className="d-flex mb-2 mb-sm-0">
                ...
                <div className="d-block flex-grow-1">
                  ...
                  <div className="small text-secondary">
                    <FaCircle
                      className={`text-${
                        activeChat.status === "offline" ? "danger" : "success"
                      } me-1`}
                    />
                    {activeChat.status}
                  </div>
            ...
            <SimpleBar className="chat-conversation-content">
        ...
        <CardFooter>
          ...
          >
            ...
            <Dropdown drop="up" className="d-inline-block">
              <DropdownToggle
                type="button"
                className="btn h-100 btn-sm btn-danger-soft ms-sm-2 border border-transparent  content-none"
              >
